...
export function JsonEditor(props: {
  ...
  return (
    <div className="relative flex flex-grow items-stretch border border-gray-200 dark:border-transparent rounded-md overflow-hidden bg-white dark:bg-transparent transition-colors">
      <CodeMirror
        value={props.value}
