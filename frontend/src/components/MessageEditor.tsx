  ...
  return (
    <div className="flex flex-col">
      <div className="flex w-full items-center gap-2">
        <span className="text-gray-700 dark:text-[#c5c5d2] whitespace-pre-wrap break-words">
          Use
        </span>
        <div className="flex flex-col">
          {props.value.name !== undefined && (
            <select
              ...
              className="rounded-md bg-white px-2 py-1 text-sm font-medium text-gray-900 ring-1 ring-inset ring-gray-300 -top-[1px] mr-auto focus:ring-0 w-40 dark:bg-[#2a2a2a] dark:text-[#c5c5d2] dark:ring-[#3a3a3a]"
      ...
      <div className="text-gray-700 whitespace-pre-wrap break-words mt-2 mb-4 ring-1 ring-gray-300 rounded bg-white dark:text-[#c5c5d2] dark:ring-[#3a3a3a] dark:bg-[#2a2a2a]">
        <table className="my-0 divide-gray-200 dark:divide-[#3a3a3a]">
          <tbody>
              ...
              <tr key={i}>
                <td
                  className={cn(
                    ...
                    "p-2 table-cell text-sm border-r border-r-gray-200 dark:border-r-[#3a3a3a] w-0 min-w-[128px]",
                  )}
                >
                  <input
                    className="rounded-md font-medium text-sm text-gray-900 bg-white px-2 py-1 focus:ring-0 focus:outline-none dark:text-[#c5c5d2] dark:bg-[#2a2a2a]"
                    value={key}
                    onChange={(e) => {
                ...
                >
                  <div className="flex items-center">
                    <StringEditor
                      className="py-0 px-0 prose text-sm leading-normal bg-white text-gray-900 dark:bg-[#2a2a2a] dark:text-[#ececec]"
  ...
  if (typeof props.message.content === "string") {
    ...
    return (
      <StringEditor
        ...
        className="text-gray-900 text-sm leading-normal prose min-w-[65ch] bg-white border border-gray-200 dark:text-[#ececec] dark:bg-[#2a2a2a] dark:border-transparent rounded-lg px-3 py-2"
  ...
  return (
    <div className="flex flex-col mb-8 group">
      <div className="leading-6 flex flex-row">
        ...
        >
          <div className="font-medium text-sm text-gray-500 dark:text-[#8e8ea0] uppercase mt-1 w-28 flex flex-col">
            {props.message.type}
          </div>
